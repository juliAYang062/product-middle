...
$sql = "INSERT INTO users (name, email, password, phone, location, gender, birthday, account, created_at)
	VALUES ('$name', '$email','$password','$phone','$location','$gender ','$date','$account','$now')";
